...
if(isset($_POST['pro'])){
	...
	$admin_query = "select * from cot where item='$item' AND id=4";
	...
	echo "<script>alert('Your IRS verification is successfull. Press OK to continue')</script>";
	echo "<script>window.open('proceed6.php?user=".$_SESSION['user']."','_self')</script>";
	}
	else {
...
<div id="div1">
	 <p></p>
    <form method="post" action="proceed5.php?user=<?php echo $_SESSION['user']; ?>">
    <label><strong>FUNDS TRANSFER COMPLETED</strong> : Please contact payments and Audit Unit for funds deposit.   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h3 style="background-color:skyblue; color:white;"><a href="accdetail.php?user=<?php  echo $_SESSION['user'] ?>">CLOSE</a></h3></label>
