...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#">Meet Our Partners</a></li>
		</ol>
		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>Add Meet Our Partners</span>
				</div>
				<div class="box-icons">
			...
			<div class="box-content">
				<h4 class="page-header">Meet Our Partners form</h4>
				<form class="form-horizontal"  enctype="multipart/form-data" method="post" action="action6.php">
					<div class="form-group">
						<label class="col-sm-2 control-label">Title</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Title" data-toggle="tooltip" data-placement="bottom" title="Title" name="etitle">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
								<textarea class="form-control" rows="5" name="fdes"></textarea>
						</div>
					</div>
					<!--<div class="form-group">
