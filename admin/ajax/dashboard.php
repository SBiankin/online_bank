		...
		<div class="row">
			<div class="col-xs-4">
				...
				<div class="sparkline-dashboard-info">
					$00.00M
					<span class="txt-primary">TRANSFERS AMT</span>
				</div>
			</div>
			<div class="col-xs-4">
				...
				<div class="sparkline-dashboard-info">
					$00.00M
					<span class="txt-info">TOTAL</span>
				</div>
			</div>
			<div class="col-xs-4">
	...
	<div id="dashboard_tabs" class="col-xs-12 col-sm-10">
		...
		<div id="dashboard-overview" class="row" style="visibility: visible; position: relative;">
			<div id="ow-marketplace" class="col-sm-12 col-md-6">
				...
				<h4 class="page-header">VALUED CLIENTS</h4>
...
<tr align="center" bgcolor="#dedddc" style="font-size:12px">
		<td >
        <img src="images/<?php echo $row[14] ?>" width="30" height="30"></td>
        <td ><?php echo $row[2] ?></td>
                            ...
                            <td ><a class="ajax-link" href="edit_client.php?edit=<?php echo $row[0]?>">EDIT</a>
