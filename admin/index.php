			...
			<ul class="nav main-menu">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="ajax-link" href="ajax/forms_layouts.php">Register Client</a></li>
                        <li><a class="ajax-link" href="ajax/transf.php">Transfers</a></li>
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-list"></i>
						 <span class="hidden-xs">Bank Dealings</span>
					</a>
					<ul class="dropdown-menu">
						
                      <li><a class="ajax-link" href="ajax/add_trans.php">Bank Transactions</a></li>
				...
				<!--<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/file_uploader.php">Banner Slide</a></li>
