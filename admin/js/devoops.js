...
function MorrisDashboard(){
	...
	/*Morris.Donut({
		...
		data: [
			{value: 20, label: 'event', formatted: 'current' },
			{value: 35, label: 'qty', formatted: 'approx. 35%' },
			{value: 20, label: 'amt', formatted: 'approx. 20%' },
			{value: 25, label: 'tamt', formatted: 'at most 25%' }
		],
		formatter: function (x, data) { return data.formatted; }
	});*/
	/*Morris.Donut({
		...
		data: [
			{value: 17, label: 'event', formatted: 'current' },
			{value: 22, label: 'qty', formatted: 'last week' },
			{value: 10, label: 'amt', formatted: 'last month' },
